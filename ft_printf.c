...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/02 17:39:20 by kdhrif            #+#    #+#             */
/*   Updated: 2022/06/03 16:04:52 by kdhrif           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const char *ft_search_arg(va_list arg, const char *format, t_sc *sc)
{
	...
	else if (*format == 'x')
	{
		...
		ft_printhexa((unsigned int)x);
		sc->len += ft_intlen((unsigned int)x, *format);
	}
	return (++format);
}
...
int main()
{
	...
	res = ft_printf("Coucou %d\n", 21474836481);
	res2 = printf("Coucou %d\n", 21474836481);
	printf("\nres = %d\nres2 = %d\n", res, res2);
	return (0);
}
